...
domains=(fidexil.check-consulting.net hi-tech-academy.fr freelance-now.fr parents-malins.fr preparation.check-consulting.net qualiopilote.fr echecs360.fr naturalisation.check-consulting.net immo-scrapper.check-consulting.net n8n.check-consulting.net astonfly.check-consulting.fr)
