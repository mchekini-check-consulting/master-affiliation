    ...
    content: (
      <>
        ...
        <p>
          ...
          c'est précisément l'objet de notre formation <strong>Kubernetes – Fondamentaux</strong> : 21 heures,
    ...
    content: (
      <>
        ...
        <p>
          ...
          <strong> Kubernetes – Fondamentaux</strong> : 21 heures en direct avec un formateur, sur un
