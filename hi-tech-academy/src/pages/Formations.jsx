    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section
          ...
          style={{ background: 'linear-gradient(135deg, #9cbdff 0%, #dbebff 40%, #f0f7ff 75%, #f0f7ff 100%)' }}>
          <div className="max-w-site mx-auto px-4 sm:px-6 pt-36 pb-16 lg:pt-40 lg:pb-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="max-w-site mx-auto px-4 sm:px-6">
            <p className="text-xs mb-6" style={{ color: '#5f6568', ...bodyFont }}>
                ...
                return (
                  <motion.div
                    ...
                    <Link to={`/formations/${formation.id}`} className="relative block m-3 rounded-xl overflow-hidden" style={{ background: MINT, height: 150 }}>
                      ...
                      <span
                        className="absolute top-3 left-3 flex items-center gap-1 px-2.5 py-1 rounded-md text-caption font-bold"
                        style={{ background: '#dbebff', color: NAVY, ...headingFont }}>
                    ...
                    <div className="flex flex-col flex-1 px-5 pb-5 pt-1">
                      ...
                      <Link
                        ...
                        style={{ background: 'white', color: '#243037', border: '1.5px solid #dbebff', ...headingFont }}>
            ...
            <div
              ...
              style={{ background: MINT_LIGHT, border: '1px solid #dbebff' }}>
              <div>
