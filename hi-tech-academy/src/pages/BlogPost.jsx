...
import { Calendar, Clock, ArrowLeft, ArrowRight } from '@phosphor-icons/react';
      ...
      <main className="pt-32 pb-20">
        <article className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div
            ...
            <p className="text-sm mb-5" style={{ color: '#5f6568', fontFamily: "'Inter', sans-serif" }}>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {others.map((p) => (
                  <Link key={p.slug} to={`/blog/${p.slug}`} className="group block">
                    ...
                    <h3
                      className="text-sm font-bold leading-snug group-hover:text-[#000c5b] transition-colors"
                      style={{ color: '#243037', fontFamily: "'Inter', sans-serif" }}>
                      {p.title}
                    </h3>
                  </Link>
