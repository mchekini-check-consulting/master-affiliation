    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/registrations/*/trainees").permitAll()
                        .requestMatchers(HttpMethod.GET, "/registrations/positioning-test").permitAll()
                        .requestMatchers(HttpMethod.POST, "/registrations/*/positioning-test").permitAll()
                        .requestMatchers(HttpMethod.POST, "/registrations/*/trainees/*/positioning-test").permitAll()
